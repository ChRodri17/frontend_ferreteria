      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr v-for="(usuario, index) in usuarios" :key="usuario.id">
            ...
            <td>
                <button class="btn btn-primary btn-sm" @click="toEdit(usuario.id)"><i class="fa fa-edit"></i></button> |
                <button class="btn btn-danger btn-sm" @click="toDelete(usuario.id)"><i class="fa fa-trash"></i></button>
            </td>
          </tr>
        </tbody>
      </table>
